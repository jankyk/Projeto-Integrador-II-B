...
p1 = input('Digite uma pergunta sobre Segurança da Informação: ')
...
p2 = input('Digite uma pergunta sobre Segurança da Informação: ')
...
p3 = input('Digite uma pergunta sobre Segurança da Informação: ')
...
p4 = input('Digite uma pergunta sobre Segurança da Informação: ')
p4_r1 = input('Insira alteranativa de resposta 1: ')
p4_r2 = input('Insira alteranativa de resposta 2: ')
p4_r3 = input('Insira alteranativa de resposta 3: ')
